 ...
 * a plural should be used with that number or false if not. This would be useful when printing out a string such
...
// Examples
console.log(plural(a));
console.log(plural(b));
console.log(plural(c));